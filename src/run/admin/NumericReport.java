...
public class NumericReport {
    ...
    public void displayNumericReport(IAdmin iAdmin) {
        while (true) {
            ...
            System.out.println("3. thống kê 1 bài thi được nhiều người thi nhất trong tháng ");
            System.out.println("4. thống kê 1 bài thi được tìm kiếm nhiều nhất trong tháng  ");
            System.out.println("5. hiển thị 1 student có điểm thi cao nhất trong tháng");
            System.out.println("6. thống kê 1 bài thi được tìm kiếm ít nhất trong tháng ");
            System.out.println("7. Câu hỏi trả lời sai nhiều nhất trong 1 bài thi ** DEVELOPING **");
            System.out.println("8. Câu hỏi trả lời đúng nhiều nhất trong 1 bài thi ** DEVELOPING **");
            ...
            System.out.println("11. hiển thị 1 student có điểm thi thấp trong tháng");
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    iAdmin.findExamWithTheMostNumberPeopleLookFor();
                    break;
                case 5:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    iAdmin.findNumberUserAccountCreatedInMonth();
                    break;
                case 10:
                    iAdmin.findNumberTeacherAccountCreatedInMonth();
                    break;
